...
public class AdminUserController {
    ...
    // Deprecated method isEmpty has been replaced with hasLength
    ...
    public String editProcess(@PathVariable Integer id,
        ...
        User user = this.userRepository.findById(id).orElse(null);
        if(StringUtils.hasLength(userBindingModel.getPassword())
            &&StringUtils.hasLength(userBindingModel.getConfirmPassword())){
